...
public class TcpClient {
    ...
    private PrintWriter mBufferOut2;
    ...
    public void run(String msg) {
        ...
        try {
            ...
            try  {
                Log.d("TEST","MI SONO CONNESSO");
                //sends the message to the server
                mBufferOut2 = new PrintWriter(new BufferedWriter(new OutputStreamWriter(socket.getOutputStream())), true);

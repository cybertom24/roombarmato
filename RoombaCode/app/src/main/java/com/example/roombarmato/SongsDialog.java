        ...
        try {
            ...
            titleEdit.setOnEditorActionListener(new TextView.OnEditorActionListener() {
                ...
                public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                    switch (actionId) {
                        /*
                        COSA FARE QUANDO PREMO DONE (chiudere la tastiera e salvare il testo scritto)
                         */
                        ...
                        case EditorInfo.IME_ACTION_SEARCH:
                            /*
                            COSA FARE QUANDO PREMO LA SPUNTA (Salvare il testo scritto)
                             */
...
/*
            QUI INSERISCO COSA FARE IN CASO DI SI (SALVA) OPPURE NO(ANNULLA)
 */
